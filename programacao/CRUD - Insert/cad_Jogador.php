...
<body>
        ...
        <fieldset>
          ...
          <center>
              ...
              <input type="hidden" name="pagina" value="cad_Jogador.php">
              <input type="hidden" name="numero" value="4">
              Nome: <input type="text" name="n1" value="" id="n1" required = "true"><br><br>
              Time: <input type="text" name="n2" value="" id="n2" required = "true"><br><br>
              Posição: <input type="text" name="n3" value="" id="n3" required = "true"><br><br>
              Número de Gols: <input type="text" name="n4" value="" id="n4" required = "true"><br><br>
              <br><br>
              <button type="submit" name="acao" value="salvar" id="acao" class="button">Salvar</button>
              <a href="list_jogador.php">Pesquisa</a>
          </center>
        </fieldset>
    </form>
</body>
