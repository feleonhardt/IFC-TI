...
<body>
        ...
        <fieldset>
          ...
          <center>
              ...
              <input type="hidden" name="pagina" value="cad_Jogo.php">
              <input type="hidden" name="numero" value="2">
              Ano de Lançamento: <input type="text" name="n1" value="" id="n1" required = "true"><br><br>
              Classificação: <input type="text" name="n2" value="" id="n2" required = "true"><br><br>
              <br><br>
              <button type="submit" name="acao" value="salvar" id="acao" class="button">Salvar</button>
              <a href="list_jogo.php">Pesquisa</a>
          </center>
        </fieldset>
    </form>
</body>
