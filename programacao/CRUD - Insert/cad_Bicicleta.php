...
<body>
        ...
        <fieldset>
          <legend>Cadastro de Bicicletas</legend>
          <center>
              <input type="hidden" name="tabela" value="<?php echo $tb_tabela ?>">
              <input type="hidden" name="pagina" value="cad_Bicicleta.php">
              <input type="hidden" name="numero" value="3">
              Fabricante: <input type="text" name="n1" value="" id="n1" required = "true"><br><br>
              Número de Marchas: <input type="text" name="n2" value="" id="n2" required = "true"><br><br>
              Formação do Quadro: <input type="text" name="n3" value="" id="n3" required = "true"><br><br>
              <br><br>
              <button type="submit" name="acao" value="salvar" id="acao" class="button">Salvar</button>
              <a href="list_bicicleta.php">Pesquisa</a>
          </center>
        </fieldset>
    </form>
</body>
