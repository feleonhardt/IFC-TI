...
<body>
        ...
        <fieldset>
          ...
          <center>
              ...
              <input type="hidden" name="pagina" value="cad_Time.php">
              <input type="hidden" name="numero" value="3">
              Nome: <input type="text" name="n1" value="" id="n1" required = "true"><br><br>
              Número de Torcedores: <input type="text" name="n2" value="" id="n2" required = "true"><br><br>
              Cidade: <input type="text" name="n3" value="" id="n3" required = "true"><br><br>
              <br><br>
              <button type="submit" name="acao" value="salvar" id="acao" class="button">Salvar</button>
              <a href="list_time.php">Pesquisa</a>
          </center>
        </fieldset>
    </form>
</body>
