<!DOCTYPE html>
<?php
	include 'connect/connect_esportes.php';
		...
		<center>
			<?php
				if($pesquisa == "codigo"){
					...
					echo "<table border = 1>";
					echo "<tr><th>Código</th><th>Nome</th><th>Número de Praticantes";
				...
				elseif($pesquisa == "praticantes"){
					$sql = "SELECT * FROM ".$tb_marca." WHERE numero_praticantes LIKE '".$pesquisar."%' ORDER BY numero_praticantes";
					$result = mysqli_query($conexao,$sql);
					echo "<table border = 1>";
					echo "<tr><th>Código</th><th>Nome</th><th>Número de Praticantes";
					while ($row = mysqli_fetch_array($result)){
				...
				elseif($pesquisa == "todos"){
					$sql = "SELECT * FROM ".$tb_marca." WHERE codigo LIKE '".$pesquisar."%' or nome LIKE '".$pesquisar."%' or numero_praticantes LIKE '".$pesquisar."%'";
					$result = mysqli_query($conexao,$sql);
					echo "<table border = 1>";
					echo "<tr><th>Código</th><th>Nome</th><th>Número de Praticantes";
					while ($row = mysqli_fetch_array($result)){
