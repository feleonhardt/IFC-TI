<!DOCTYPE html>
<?php
	include 'connect/connect_funcionario.php';
		...
		<center>
			<?php
				if($pesquisa == "codigo"){
					...
					echo "<table border = 1>";
					echo "<tr><th>Código</th><th>Nome</th><th>Salario</th><th>Data de Admissão</th>";
				...
				elseif($pesquisa == "salario"){
					$sql = "SELECT * FROM ".$tb_marca." WHERE salario LIKE '".$pesquisar."%' ORDER BY salario";
					$result = mysqli_query($conexao,$sql);
					echo "<table border = 1>";
					echo "<tr><th>Código</th><th>Nome</th><th>Salario</th><th>Data de Admissão</th>";
					while ($row = mysqli_fetch_array($result)){
				...
				elseif($pesquisa == "admissao"){
					$sql = "SELECT * FROM ".$tb_marca." WHERE data_admissao LIKE '".$pesquisar."%' ORDER BY data_admissao";
					$result = mysqli_query($conexao,$sql);
					echo "<table border = 1>";
					echo "<tr><th>Código</th><th>Nome</th><th>Salario</th><th>Data de Admissão</th>";
					while ($row = mysqli_fetch_array($result)){
				...
				elseif($pesquisa == "todos"){
					$sql = "SELECT * FROM ".$tb_marca." WHERE codigo LIKE '".$pesquisar."%' or nome LIKE '".$pesquisar."%' or salario LIKE '".$pesquisar."%' or data_admissao LIKE '".$pesquisar."%'";
					$result = mysqli_query($conexao,$sql);
					echo "<table border = 1>";
					echo "<tr><th>Código</th><th>Nome</th><th>Salario</th><th>Data de Admissão</th>";
					while ($row = mysqli_fetch_array($result)){
