<!DOCTYPE html>
<?php
	include 'connect/connect_aluno.php';
		...
		<center>
			<?php
				if($pesquisa == "codigo"){
					...
					echo "<table border = 1>";
					echo "<tr><th>Código</th><th>Nome</th><th>Data de Nascimento</th><th>Curso</th>";
				...
				elseif ($pesquisa == "dataNasc") {
					$sql = "SELECT * FROM ".$tb_marca." WHERE data_nascimento LIKE '".$pesquisar."%' ORDER BY data_nascimento";
					$result = mysqli_query($conexao,$sql);
					echo "<table border = 1>";
					echo "<tr><th>Código</th><th>Nome</th><th>Data de Nascimento</th><th>Curso</th>";
					while ($row = mysqli_fetch_array($result)){
				...
				elseif($pesquisa == "curso"){
					$sql = "SELECT * FROM ".$tb_marca." WHERE curso LIKE '".$pesquisar."%' ORDER BY curso";
					$result = mysqli_query($conexao,$sql);
					echo "<table border = 1>";
					echo "<tr><th>Código</th><th>Nome</th><th>Data de Nascimento</th><th>Curso</th>";
					while ($row = mysqli_fetch_array($result)){
				...
				elseif($pesquisa == "todos"){
					$sql = "SELECT * FROM ".$tb_marca." WHERE nome LIKE '".$pesquisar."%' or data_nascimento LIKE '".$pesquisar."%' or curso LIKE '".$pesquisar."%' or codigo LIKE '".$pesquisar."%'";
					$result = mysqli_query($conexao,$sql);
					echo "<table border = 1>";
					echo "<tr><th>Código</th><th>Nome</th><th>Data de Nascimento</th><th>Curso</th>";
					while ($row = mysqli_fetch_array($result)){
