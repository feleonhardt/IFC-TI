<!DOCTYPE html>
<?php
	include 'connect/connect_pais.php';
		...
		<center>
			<?php
				if($pesquisa == "codigo"){
					...
					echo "<table border = 1>";
					echo "<tr><th>Código</th><th>Nome</th><th>Sigla</th><th>Continente</th>";
				...
				elseif($pesquisa == "continente"){
					$sql = "SELECT * FROM ".$tb_marca." WHERE continente LIKE '".$pesquisar."%' ORDER BY continente";
					$result = mysqli_query($conexao,$sql);
					echo "<table border = 1>";
					echo "<tr><th>Código</th><th>Nome</th><th>Sigla</th><th>Continente</th>";
					while ($row = mysqli_fetch_array($result)){
				...
				elseif($pesquisa == "todos"){
					$sql = "SELECT * FROM ".$tb_marca." WHERE codigo LIKE '".$pesquisar."%' or nome LIKE '".$pesquisar."%' or sigla LIKE '".$pesquisar."%' or continente LIKE '".$pesquisar."%'";
					$result = mysqli_query($conexao,$sql);
					echo "<table border = 1>";
					echo "<tr><th>Código</th><th>Nome</th><th>Sigla</th><th>Continente</th>";
					while ($row = mysqli_fetch_array($result)){
