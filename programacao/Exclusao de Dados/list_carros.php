			...
			<?php
				if($pesquisa == ''){
					...
					elseif($pesquisa == "data"){
						$sql = "SELECT * FROM ".$tb_carro." WHERE data_venda = '".$pesquisar."' ORDER BY data_venda";
					}
					...
					while ($row = mysqli_fetch_array($result)){
						...
						echo "<td>".$row[2]."</td>";
						echo "<td>".$row[3]."</td>";
						echo "<td><a href = 'acaoMarca.php?acao=excluir&codigo=$row[0]&tabela=carro&nome=list_carros.php'>Excluir</a></td>";
						echo "</tr>";
					}
					echo "</table><br><br>";
			?>
