			...
			<?php
				if($pesquisa == ''){
					...
					elseif($pesquisa == "data"){
						$sql = "SELECT * FROM ".$tb_enchente." WHERE data_dia = '".$pesquisar."' ORDER BY data_dia";
					}
					...
					while ($row = mysqli_fetch_array($result)){
						...
						echo "<td>".$row[1]."</td>";
						echo "<td>".$row[2]."</td>";
						echo "<td><a href = 'acaoMarca.php?acao=excluir&codigo=$row[0]&tabela=enchente&nome=list_enchente.php'>Excluir</a></td>";
						echo "</tr>";
					}
					echo "</table><br><br>";
			?>
