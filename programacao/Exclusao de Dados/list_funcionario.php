			...
			<?php
				if($pesquisa == ''){
					...
					elseif($pesquisa == "admissao"){
						$sql = "SELECT * FROM ".$tb_funcionario." WHERE data_admissao = '".$pesquisar."' ORDER BY data_admissao";
					}
				}
					...
					while ($row = mysqli_fetch_array($result)){
						...
						echo "<td>".$row[2]."</td>";
						echo "<td>".$row[3]."</td>";
						echo "<td><a href = 'acaoMarca.php?acao=excluir&codigo=$row[0]&tabela=funcionario&nome=list_funcionario.php'>Excluir</a></td>";
						echo "</tr>";
					}
					echo "</table><br><br>";
			?>
