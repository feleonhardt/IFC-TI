			...
			<?php
				if($pesquisa == ''){
					...
					elseif($pesquisa == "data"){
						$sql = "SELECT * FROM ".$tb_email." WHERE data_dia = '".$pesquisar."' ORDER BY data_dia";
					}
				}
					...
					while ($row = mysqli_fetch_array($result)){
						...
						echo "<td>".$row[3]."</td>";
						echo "<td>".$row[4]."</td>";
						echo "<td><a href = 'acaoMarca.php?acao=excluir&codigo=$row[0]&tabela=email&nome=list_email.php'>Excluir</a></td>";
						echo "</tr>";
					}
					echo "</table><br><br>";
			?>
