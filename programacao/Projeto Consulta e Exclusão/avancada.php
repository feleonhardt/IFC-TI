		...
		<form action="" method="post">
			<fieldset>
					<center>
						...
						Inicio: <input type="text" id="txtBusca" name="pesquisar1" placeholder="Digite..." value="<?php echo $pesquisar1 ?>"/><br><br>
						Fim: <input type="text" id="txtBusca" name="pesquisar2" placeholder="Digite..." value="<?php echo $pesquisar2 ?>"/><br><br><br>
						<input type="submit">
