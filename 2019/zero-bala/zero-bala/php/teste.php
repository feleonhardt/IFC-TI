...
//-------------------Recebe todos os dados------------------------
  ...
  //===========Funções responsáveis por receber os dados==========
...
//--------------------Verifica quais os dados preechidos----------
  ...
  //===========Funções responsáveis por verificar os dados========
  ...
  function validaCliqueBotao(){//verifica se algum botão foi clicado
        if ($GLOBALS['botaoInserir'] == "Inserir") {//se o valor recebido do objeto botaoInserir o botão foi clicado
          ...
          formuluarioPesquisas();//exibe um o formulário
...
//---------------------Pesquisas Avançadas------------------------
  ...
  function aniversariantes($mes){//Função geral que executa as outras
  ...
  function dominioEmail($dominio){//Função geral que executa as outras
  ...
  function nomeAproximacao($caracteresAproximacao){//função geral que executa as outras
      ...
      <div id='accordion'>
       <div class='card'>
         <div class='card-header' id='headingOne'>
           <h5 class='mb-0'>
             <button class='btn btn-light collapsed' data-toggle='collapse' data-target='#collapseOne' aria-expanded='false' aria-controls='collapseOne'>
               Buscar por mês de aniversário.
             </button>
           </h5>
         </div>
         ...
         <div class='card-header' id='headingThree'>
           <h5 class='mb-0'>
             <button class='btn btn-light collapsed' data-toggle='collapse' data-target='#collapseThree' aria-expanded='false' aria-controls='collapseThree'>
               Buscar por aproximação de nome
             </button>
           </h5>
         </div>
  ...
  function formuluarioPesquisas(){//formulario com um select para os meses, e input para dominio e aproximação
    ...
    //----------Botão listar---------
      ...
      function cabeçalhoTabela(){//Cria o cabeçalho da Tabela
        echo "
        <form align='right'>
          <input type='submit' class='fecha' value='x'>
        </form>
        <br>
